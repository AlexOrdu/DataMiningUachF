...
def dataToint(data):
    print(data)
    print('-----------------')
    data = data['id'].astype(int)
    print(data)
    return data


if __name__ == '__main__':
    #data = pandas.read_csv('outputtrain.csv')
    #data = pandas.read_csv('outputtest.csv')
    data = pandas.read_csv('predicted_kaggle_Bagging_Regressor.csv')

    """decision_tree(data)
    mlp_classifier(data)
    #write_file(data, 'outputtrainmining.csv')
    write_file(data, 'outputtestmining.csv')
    """

    dataToint(data)
    write_file(data, 'draft.csv')
