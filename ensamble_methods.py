...
if __name__ == '__main__':
    data = pandas.read_csv('FinalProject/outputtestensamble.csv')
    data2 = pandas.read_csv('FinalProject/finaldata/final.csv')
    """decision_tree(data)
    mlp_classifier(data)
    ensemble_methods_classifiers(data)
    #xgboost(data)
    write_file(data, 'outputtrainensamble.csv')
    #write_file(data, 'outputtestensamble.csv')"""
