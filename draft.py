...
if __name__ == '__main__':
    # Open data
    print("DATA LOADING...")
    train_data = utils.load_data("FinalProject/outputtrainensamble.csv")
    ...
    test_data = utils.load_data("FinalProject/finaldata/final.csv")
    ...
    print("FILLING MISSING VALUES WITH CONSTANT")
    ...
    print("REPLACING MISSING VALUES WITH CONSTANT")
    ...
    print("TRANSFORMING NOMINAL DATA WITH NUMERICAL")
    ...
    for name, em_clf in zip(names, models):
        ...
        path = "predicted_kaggle_" + str(name) +".csv"
